const bfCheckNamespace = ( name ) => {
    const namespace = [ { name: 'core/heading' } ];
                ...
                {isSelected &&
                    <InspectorAdvancedControls>
                        ...
                        <ToggleControl
                            ...
                            help={
                                displaySummary
                                    ? 'Title used as summary'
                                    : 'No summary'
                            }
                            checked={ displaySummary }
                            onChange={ () => setAttributes({ displaySummary: !displaySummary }) }
                        />
...
wp.hooks.addFilter(
    ...
    'beflex/summary-apply-class',
    summaryApplyExtraClass
);
